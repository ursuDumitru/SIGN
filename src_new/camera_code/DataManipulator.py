...
class DataManipulator:
    ...
    def __init__(self, data_set_file_path, sign_labels_file_path) -> None:
        ...
        # control variables for saving mode, both static and dynamic
        self.sign_labels = []
        self.sign_labels_counted = []
        self.sign_labels_index = -1  # TODO find the place where this have to be reset
        # self.sign_labels_sign = -1 # FIXME is this even needed ?
